...
const AuditorForm = () => {
  ...
  const apiConfig = {
    apiUrl:
      process.env.NEXT_PUBLIC_API_URL || "https://crmapi.thinkdatalabs.com/api",
    apiHeaders: {
      "x-access-api-key":
        process.env.NEXT_PUBLIC_ACCESS_API_KEY ||
        "c8020ac4ad9745fa6e0a8deaccc4ba5c525f58dbf85a01de9dc0f50c9e1a15ae",
      "x-public-api-key":
        process.env.NEXT_PUBLIC_PUBLIC_API_KEY ||
        "282af17a9b504ce038cd37cc6e91127b",
    },
  };

  const { fetchCountries, fetchStates, fetchCities, submitForm } =
  ...
  const onSubmit = async (data: ContactFormData) => {
    ...
    try {
      ...
      if (error.response?.status === 400) toast.error("Invalid form data.");
  ...
  return (
    ...
    >
      <div className="container mx-auto py-10 px-4">
        <h2
          className="flex justify-center items-center text-emerald-600 pt-12 pb-8 text-3xl uppercase font-extrabold drop-shadow-sm"
          style={{ color: "#059669" }}
        >
